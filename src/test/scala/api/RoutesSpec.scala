...
import persistence.entities.{ Test, JsonProtocol, SimpleProject, Project }
...
class RoutesSpec extends AbstractAPITest {
  ...
  "Project Routes" should {
    ...
    "trigger route runs successful" in {
      ...
      modules.testsDal.save(Test(None, Some(2), "commit", Some(any[Timestamp]), None)) returns Future(3)
